...
<Tabs items={["Web & API", "Data & Validation", "Async & Networking", "Observability & Tooling"]}>
...
- **Python-JOSE & Passlib**: For JWT-based authentication and password hashing.
...
**Data Layer:**
- **Pydantic v2**: Core data validation and settings management.
- **SQLModel**: Type-safe database operations with SQLAlchemy and Pydantic.
- **Pandas**: Used in the new loader architecture for data manipulation.
- **PyYAML**: For loading configuration from YAML files.

</Tab>

<Tab value="Async & Networking">
...
**Async & Networking:**
- **httpx & aiohttp**: Modern async HTTP clients for validation and fetching.
- **aiocache**: Asynchronous caching framework (memory, Redis, etc.).
- **aiosqlite**: Async driver for SQLite database.
- **Tenacity**: Intelligent retry logic with exponential backoff.

</Tab>

<Tab value="Observability & Tooling">
...
**Monitoring & Tooling:**
- **Loguru**: Structured and simplified logging.
- **Rich & Textual**: Enhanced terminal output, TUI, and debugging.
- **Typer**: For building the command-line interface.
- **Prometheus FastAPI Instrumentator**: For exposing Prometheus metrics from the API.
