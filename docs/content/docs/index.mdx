...
<Mermaid
  chart="flowchart TB
    ...
    subgraph CORE[⚙️ Core Orchestration]
        ...
        CONFIG[Configuration<br/>config.py • Settings]
    end

    %% Data Models
    subgraph MODELS[📋 Data Models]
        CORE_MODELS[Core Models<br/>models.py • Pydantic]
    ...
    subgraph VALID[🔒 Validation System]
        VAL[ProxyValidator<br/>validator.py • 788 lines]
    ...
    subgraph ROT[🔄 Rotation Engine]
        ROTOR[ProxyRotator<br/>rotator.py • 402 lines]
        RR[Round Robin]
    ...
    subgraph EXPORT[� Export & Monitoring]
        EXP[ProxyExporter<br/>exporter.py • 742 lines]
        HEALTH_RPT[Health Reporting<br/>CLI/TUI Integration]
        LOG[Structured Logging<br/>logger.py • Loguru]
