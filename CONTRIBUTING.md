...
- `just` command runner (install via `brew install just` or see https://just.systems/)
...
Example:
```bash
git checkout -b feature/add-socks-support main
```
...
3. **Update documentation**: If changing public APIs, edit `web/content/docs/` (Fumadocs MDX) and regenerate generated reference pages:
   ...
   Commit both hand-written MDX and regenerated files under `web/content/docs/generated/` and `web/content/generated/`.
...
- **Documentation**: See [README.md](README.md) and the published docs site source in [web/content/docs/](web/content/docs/)
