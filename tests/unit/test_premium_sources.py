...
class TestSecurityFeatures:
    ...
    def test_password_not_leaked_in_repr(self) -> None:
        ...
        assert "http://user" not in repr_str, "URL username leaked in repr!"
    ...
    def test_create_premium_proxy_hides_credentials(self) -> None:
        ...
        assert "myusername" not in repr_str
    ...
    def test_logging_safety(self) -> None:
        ...
        assert "admin" not in log_output, "URL username leaked in logs!"
    ...
    def test_username_field_not_leaked_in_repr(self) -> None:
        """Test separate username field is also redacted in repr()."""
        config = PremiumProxyConfig(
            url="http://proxy.example.com:8080",
        ...
        assert "account-user" not in repr_str
