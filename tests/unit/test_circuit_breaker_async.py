...
class TestAsyncCircuitBreakerCreate:
    """Test AsyncCircuitBreaker.create() class method."""

    async def test_from_config_uses_config_values(self):
        ...
        cb = AsyncCircuitBreaker.create("test-proxy", config)
    ...
    async def test_from_config_without_config_uses_defaults(self):
        """Test that create without config uses default values."""
        cb = AsyncCircuitBreaker.create("test-proxy", None)
    ...
    async def test_from_config_kwargs_override_config(self):
