...
| `web/content/docs/generated/python-api.mdx` | Regenerated by `pnpm --dir web run docs:generate` |
| `web/content/docs/generated/cli-reference.mdx` | Regenerated by `pnpm --dir web run docs:generate` |
| `web/content/docs/generated/proxy-sources.mdx` | Regenerated by `pnpm --dir web run docs:generate` |
...
10. Regenerate the Fumadocs reference pages that mirror source names or collections:
    ```bash
    pnpm --dir web run docs:generate
    ```
    This rewrites `web/content/docs/generated/proxy-sources.mdx` and `python-api.mdx` from
    the runtime source registry — do not hand-edit those generated files.
