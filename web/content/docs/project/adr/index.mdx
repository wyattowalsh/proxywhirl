...
description: Index of ProxyWhirl ADRs.
---
...
### [ADR-001: Three-Tier Cache Architecture](/docs/project/adr/001-three-tier-cache)
**Status**: Accepted
...
### [ADR-002: Circuit Breaker Pattern](/docs/project/adr/002-circuit-breaker)
**Status**: Accepted
...
### [ADR-003: Strategy Pattern for Rotation](/docs/project/adr/003-strategy-pattern)
**Status**: Accepted
...
### [ADR-004: Storage Backend Decisions](/docs/project/adr/004-storage-backend)
**Status**: Accepted
...
### [ADR-005: Schema Migration Strategy](/docs/project/adr/005-migrations)
**Status**: Accepted

Forward-only migration approach, dual read paths via `dict_to_proxy()`, and git-friendly analytics DB conventions.

### [ADR-006: Cross-Proxy Failover Orchestration](/docs/project/adr/006-failover)
**Status**: Accepted
