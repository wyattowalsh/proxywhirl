...
class BootstrapConfig(BaseModel):
    ...
    Attributes:
        ...
        sources: Explicit list of sources to fetch from. None = all enabled built-in sources.
        sample_size: Optional source sample size. None = all enabled built-in sources.
