...
class UserManager:
    ...
    def __init__(self):
        ...
        if not self.admin_password:
            print("⚠️  WARNING: Using default admin password. Set PROXYWHIRL_ADMIN_PASSWORD environment variable!")
            self.admin_password = "changeme123!"
            
        if not self.user_password:
            print("⚠️  WARNING: Using default user password. Set PROXYWHIRL_USER_PASSWORD environment variable!")
    ...
    def create_user(self, username: str, password: str, email: str = None, 
                   scopes: List[str] = None, disabled: bool = False) -> UserInDB:
